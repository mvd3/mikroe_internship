<div class="actions col_2">
	...
	<table>
		...
		<tr><td><button class="medium blue"><?php echo $this->Html->link(__('List Materials'), array('action' => 'index')); ?></button></td></tr></table>
</div>
<div class="materials form col_10">
<?php echo $this->Form->create('Material'); ?>
	...
	echo $this->Form->input('material_status', array('options' => $statusOptions, 'selected' => $currentStatus));
