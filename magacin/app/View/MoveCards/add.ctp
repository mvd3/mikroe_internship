...
<?php echo $this->Form->create('MoveCard'); ?>
	<fieldset>
		...
		<table>
			<tr>
				<td><?php echo $this->Form->input('move_from', array('options' => $locationOptions)); ?></td>
				<td><?php echo $this->Form->input('move_to', array('options' => $locationOptions)); ?></td>
				<td><?php echo $this->Form->input('type', array('options' => $typeOptions)); ?></td>
				<td><?php echo $this->Form->input('work_order', array('required' => false)); ?></td>
			</tr>
    ...
    <table id="request-table">
        ...
        <tbody>
					...
					<tr>
					    <td>
					        <?php echo $this->Form->input("Item.{$key}.item", array(
										'type' => 'select',
					    ...
					    <td>
					        <?php echo $this->Form->input("Item.{$key}.quantity", array('required' => true)); ?>
					    </td>
					    <td class="actions">
