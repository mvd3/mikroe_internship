<div class="actions col_2">
	...
	<table>
		...
		<tr><td><button class="medium blue"><?php echo $this->Html->link(__('List Service Products'), array('action' => 'index')); ?></button></td></tr></table>
</div>
<div class="serviceProducts form col_10">
<?php echo $this->Form->create('ServiceProduct'); ?>
	...
	<?php
		...
		echo $this->Form->input('eccn', array('default' => $eccn, 'required' => false));
		echo $this->Form->input('release_date', array('default' => $releaseDate, 'required' => false));
